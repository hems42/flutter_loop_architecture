...
PageRouteBuilder _createAnimaiton(Widget page,
  ...
  return PageRouteBuilder(
      ...
      transitionsBuilder: (context, animation, secondaryAnimation, child) =>
          getAnimation(context, animation, secondaryAnimation, child),
      settings: settings);
}
...
Widget getAnimation(BuildContext context, Animation<double> animation,
    Animation<double> secondAnimation, Widget child) {
  return SlideTransition(
      position:
          Tween<Offset>(begin: getdirectedOffset(_Axis.DOWN), end: Offset.zero)
              .animate(animation),
      child: child);
}
