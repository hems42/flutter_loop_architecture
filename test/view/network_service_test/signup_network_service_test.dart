...
import 'package:flutter_notebook/view/authentication/_signup/service/abstract/ife_signup_network_service.dart';
  ...
  test('signup user test', () async {
    ...
    try {
      final response = await signupNetworkService.signup(SignupRequestModel(
          eMail: "lali@vali", password: "vali", userNickName: "vali"));
